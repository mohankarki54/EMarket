...
public class TimeCalculation {
    ...
    public String timeDifference1(Date current, Date start){
        String value = " ";
        if(start != null) {
            long diff = current.getTime() - start.getTime();
            long diffSeconds = diff / 1000 % 60;
            ...
            if (diffDays != 0) {
                if (diffDays != 1) {
                    value = "commented " + String.valueOf(diffDays) + " days ago";
                } else {
                    value = "commented " + String.valueOf(diffDays) + " day ago";
                }
            } else if (diffHours != 0) {
                if (diffHours != 1) {
                    value = "commented " + String.valueOf(diffHours) + " hours ago";
                } else {
                    value = "commented " + String.valueOf(diffHours) + " hour ago";
                }

            } else if (diffMinutes != 0) {
                if (diffMinutes != 1) {
                    value = "commented " + String.valueOf(diffMinutes) + " minutes ago";
                } else {
                    value = "commented " + String.valueOf(diffMinutes) + " minute ago";
                }

            } else if (diffSeconds != 0) {
                if (diffSeconds != 1) {
                    value = "commented " + String.valueOf(diffSeconds) + " seconds ago";
                } else {
                    value = "commented " + String.valueOf(diffSeconds) + " second ago";
                }
            }
        }
        return value;
